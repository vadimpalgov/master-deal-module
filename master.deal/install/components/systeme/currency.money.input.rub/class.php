...
class CCurrencyMoneyInputRubComponent extends \CBitrixComponent
{
	...
	{
		$currencyList = Currency\Helpers\Editor::getListCurrency();

        if($currencyList['RUB']){
            $this->currencyList = array_intersect_key($currencyList, array_flip(['RUB']));
        } else {
